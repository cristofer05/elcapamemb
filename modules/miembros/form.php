          ...
          <form role="form" class="form-horizontal" action="modules/miembros/proses.php?act=update" method="POST">
            <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Cedula</label>
                <div class="col-sm-5">
                  <input type="text" id="cedula" class="form-control" name="cedula" autocomplete="off" value="<?php echo $data['cedula']; ?>" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Fecha Nacimiento</label>
                <div class="col-sm-5">
                  <input type="date" name="fnacimiento" class="form-control" autocomplete="off" step="1" value="<?php echo $data['fnacimiento']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Sexo</label>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Ocupacion</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="ocupacion" autocomplete="off" value="<?php echo $data['ocupacion']; ?>" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Correo</label>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Telefono</label>
                <div class="col-sm-5">
                  <input type="tel" id="telefono" class="form-control" name="telefono" autocomplete="off" value="<?php echo $data['telefono']; ?>" required>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label">Categoria</label>
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Fecha Expiracion</label>
                <div class="col-sm-5">
                    <input type="date" name="fexpiracion" class="form-control" autocomplete="off" step="1" min="2018-01-01" max="2099-12-31" value="<?php echo $data['fexpiracion']; ?>">
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label"></label>
